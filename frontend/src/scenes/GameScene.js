...
const ROOM_ID_PREFIX = 'biubiufight-room-';
export default class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('player_walk', 'assets/walking.png', { frameWidth: 120, frameHeight: 120 });
    ...
    createGround() {
        // 创建一个透明的物理地面
        this.ground = this.add.rectangle(400, 590, 800, 20, 0x000000, 0);
    ...
    createUI() {
        // 创建游戏UI
        this.add.text(10, 10, 'BiuBiu FIGHT', {
            fontSize: '16px',
        ...
        // 玩家数量显示
        this.playerCountText = this.add.text(10, 30, '玩家: 1', {
            fontSize: '12px',
            fontFamily: 'Courier New',
            color: '#cccccc'
        });
        ...
        if (this.player1Address != undefined) {
            ...
            // 等待玩家2加入提示
            this.waitText = this.add.text(400, 100, '等待玩家2加入...', {
                fontSize: '18px',
                fontFamily: 'Courier New',
                color: '#ffffff'
            }).setOrigin(0.5);
    ...
    updateUI() {
        // 更新玩家数量
        this.playerCountText.setText(`玩家: ${this.players.length}`);
        // 如果有等待提示，且玩家数>=2，则隐藏
    ...
    gameOver(loser) {
        ...
        // 胜负信息
        this.add.text(400, 290, isLocalWin ? '你赢了!' : '对手赢了!', {
            fontSize: '20px',
            fontFamily: 'Courier New',
        ...
        // “确认”按钮
        if (isLocalWin) { 
            const confirmBtn = this.add.text(340, 350, '领取奖励', {
                fontSize: '16px',
                fontFamily: 'Courier New',
                color: '#222',
                backgroundColor: '#eee',
        ...
        // “返回”按钮
        const backBtn = this.add.text(460, 350, '返回', {
            fontSize: '16px',
            fontFamily: 'Courier New',
            color: '#222',
            backgroundColor: '#eee',
