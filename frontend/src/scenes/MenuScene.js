...
export default class MenuScene extends Phaser.Scene {
    ...
    async create() {
        ...
        // 创建标题
        this.add.text(width / 2, height / 3, 'BiuBiu FIGHT', {
            fontSize: '32px',
            fontFamily: 'Courier New',
            color: '#ff6b6b',
            stroke: '#000000',
        ...
        // 创建开始按钮
        const startButton = this.add.text(width / 2, height / 2, '创建房间', {
            fontSize: '24px',
            fontFamily: 'Courier New',
            color: '#ffffff',
            stroke: '#000000',
        ...
        // 创建加入按钮
        const joinButton = this.add.text(width / 2, height * 0.6, '加入房间', {
            fontSize: '24px',
            fontFamily: 'Courier New',
            color: '#ffffff',
            stroke: '#000000',
        ...
        // 创建说明文本
        this.add.text(width / 2, height * 0.7, 'Space:跳跃 A:后退/防御 D:前进', {
            fontSize: '16px',
            fontFamily: 'Courier New',
            color: '#cccccc'
        }).setOrigin(0.5);

        this.add.text(width / 2, height * 0.75, 'J/鼠标左键:近战 K/鼠标右键:远程', {
            fontSize: '16px',
            fontFamily: 'Courier New',
            color: '#cccccc'
        }).setOrigin(0.5);
